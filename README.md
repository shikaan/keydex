...
<p align="center">
  <img width="540" alt="screenshot" src="https://github.com/user-attachments/assets/a58cfe6d-8f3a-462c-a20f-b894bc79b14f" />
</p>
...
_MacOS and Linux_
```sh
curl -s https://shikaan.github.io/sup/install | REPO=shikaan/keydex sh -
```

or

```sh
wget -q https://shikaan.github.io/sup/install -O- | REPO=shikaan/keydex sh -
```
